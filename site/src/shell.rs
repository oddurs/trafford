...
/// The landing page: one screen, then the note's own body under it.
pub fn landing(ctx: &Ctx<'_>, page: &Page<'_>, hero: &str) -> String {
    let content = format!(
...
fn header(ctx: &Ctx<'_>) -> String {
    format!(
        r#"<header class="top">
<a class="brand" href="{home}"><span class="brand-mark">▌</span>trafford</a>
<nav class="top-nav">
<a href="{docs}">Docs</a>
...
<p>trafford is MIT licensed. This site is generated from the same notes the app reads — see <a href="{docs}">the docs</a>.</p>
</footer>"#,
        docs = escape_attr(&ctx.href("docs/getting-started/")),
    )
}
