...
`site/`, a workspace member (#0033), never a dependency of the binary. It is
...
polling rather than taking `notify` (#0036 said otherwise). A docs tree is
...
the binary" guarantee in #0033 trivially checkable rather than argued.
