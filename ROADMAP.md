...
- [x] `0034` Build the site from a directory of notes, deterministically <sup>feature · p0 · site</sup>
- [x] `0035` The development server binds port zero <sup>feature · p0 · site</sup>
- [x] `0036` Reload the open page on save, over one connection <sup>feature · p1 · site</sup>
- [x] `0037` Generate the site's palette from the app's themes <sup>chore · p1 · theme</sup>
- [x] `0038` Every screenshot is generated by the probe, never pasted in <sup>chore · p1 · docs</sup>
- [x] `0039` CI gates the site the way it gates the crate <sup>chore · p1 · site</sup>
- [x] `0040` Deploy from CI, and from nowhere else <sup>chore · p0 · packaging</sup>
- [x] `0041` Publish rustdoc under /api as part of the same build <sup>chore · p2 · docs</sup>
- [x] `0042` Smoke-test the site by serving it on a random port <sup>chore · p1 · site</sup>
- [x] `0043` The landing page is one screen, and the screenshot is real <sup>feature · p1 · site</sup>
...
- [ ] `0044` Search the docs from an index the build produces <sup>feature · p2 · site</sup>
