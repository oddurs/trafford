...
- [ ] `0037` Generate the site's palette from the app's themes <sup>chore · p1 · theme</sup>
- [ ] `0038` Every screenshot is generated by the probe, never pasted in <sup>chore · p1 · docs</sup>
