...
`##········` 18% · 2 of 11 done · due 2027-02-28
...
- [ ] `0158` Paste a Ghostty theme and watch the site wear it <sup>feature · p2 · site</sup>
- [ ] `0159` Links to the site unfurl as something <sup>chore · p2 · site</sup>
...
- [x] `0146` Reload the open page on save, over one connection <sup>feature · p1 · site</sup>
- [x] `0147` Generate the site's palette from the app's themes <sup>chore · p1 · theme</sup>
- [x] `0148` Every screenshot is generated by the probe, never pasted in <sup>chore · p1 · docs</sup>
- [x] `0149` CI gates the site the way it gates the crate <sup>chore · p1 · site</sup>
- [x] `0150` Deploy from CI, and from nowhere else <sup>chore · p0 · packaging</sup>
- [x] `0151` Publish rustdoc under /api as part of the same build <sup>chore · p2 · docs</sup>
- [x] `0152` Smoke-test the site by serving it on a random port <sup>chore · p1 · site</sup>
- [x] `0153` The landing page is one screen, and the screenshot is real <sup>feature · p1 · site</sup>
- [x] `0155` Give the site a typeface <sup>chore · p1 · site</sup>
- [x] `0156` The landing page has a grid, not a column <sup>feature · p1 · site</sup>
- [x] `0157` The hero plays, and it is the real program <sup>feature · p1 · site</sup>
- [x] `0164` What builds the site, and where does its code live? <sup>spike · p0 · site</sup>
- [x] `0165` Make the crate a workspace so site tooling never ships in the binary <sup>chore · p0 · packaging</sup>
- [x] `0166` Build the site from a directory of notes, deterministically <sup>feature · p0 · site</sup>
- [x] `0167` The development server binds port zero <sup>feature · p0 · site</sup>
- [x] `0168` A landing page of showcases, not a column <sup>feature · p1 · site</sup>
...
- [ ] `0154` Search the docs from an index the build produces <sup>feature · p2 · site</sup>
- [ ] `0163` trafford, running in the browser <sup>feature · p2 · site</sup>
